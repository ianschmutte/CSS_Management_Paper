...
\input{./exhibits/RAIS_sum}
\clearpage
\begin{table}[h t]
    \caption{ \label{tab:wms_summ}}
    \begin{center}
    \scalebox{0.7}{
        \input{./exhibits/wms_sumstats}
    }
    \end{center}
...
\clearpage
\input{./exhibits/dynamic_selection.tex}
\clearpage
\begin{figure}
...
\clearpage
\input{./exhibits/tab_WMS-RAIS-PIA-sumstats.tex}
...
\clearpage
\input{./exhibits/tab_AKM_vardecomp}
\clearpage
\input{./exhibits/AKM_corr}
